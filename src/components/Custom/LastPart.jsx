...
const LastPart = () => {
    ...
    return (
        <div className='px-44 py-8 w-full'>
            <div className='flex gap-4 rounded text-sm w-full overflow-x-auto overscroll-color-blue-500'>
                <div className='bg-white flex flex-col gap-6 rounded p-2 min-w-[186px] min-h-[166px] '>
                    <div className='ml-[9.4rem] relative'>
                ...
                <div className=' bg-white flex flex-col gap-7 rounded p-2 min-w-[186px] min-h-[166px]'>
                    <div className='ml-[9.4rem] relative'>
                        <DropDown text={'When the countdown is finished, the system will automatically move to the next question.'} />
                    </div>
                    <div className='flex flex-col gap-2 items-center justify-center'>
